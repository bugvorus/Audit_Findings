In this section, I have assigned a unique number to each `client` instead of using their `name`, and the severity of each finding is labeled using its first letter.
